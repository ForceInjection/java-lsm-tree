...
# 性能基准测试配置
# 调整操作数到 50,000，确保在 1 分钟内完成，同时数据量足够触发 Flush
BENCHMARK_OPERATIONS=${BENCHMARK_OPERATIONS:-50000}
...
# 设置 MemTable 阈值为 10,000 条目，强制在 50,000 次操作中触发约 5 次 Flush
BENCHMARK_MEMTABLE_THRESHOLD=${BENCHMARK_MEMTABLE_THRESHOLD:-10000}
...
PERFORMANCE_TIMEOUT=${PERFORMANCE_TIMEOUT:-1200}
MEMORY_TIMEOUT=${MEMORY_TIMEOUT:-300}
STRESS_TIMEOUT=${STRESS_TIMEOUT:-600}

# 压力测试配置
STRESS_OPERATIONS=${STRESS_OPERATIONS:-20000}
